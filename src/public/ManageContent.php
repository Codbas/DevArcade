...
<form id="upload-form" hx-post="../includes/uploadContent.php" hx-encoding="multipart/form-data" hx-target="#upload-message" hx-swap="innerHTML" >
    ...
    <div class="upload-container">
        <div class="title-container">
            ...
            <input type="text" id="upload-title" name="title" maxlength="40" minlength="6" pattern="^[A-Za-z0-9 !?\-,.]*$" title="Must be 6-40 characters and only include letters, numbers, spaces and punctuation !?-,." required>
        </div>
        <div class="description-container">
        <label for="description" id="description-label">Description</label>
        <input type="text" id="upload-description" name="description" maxlength="255" minlength="10" pattern="^[A-Za-z0-9 !?\-,.]*$" title="Must be 10-255 characters and only include letters, numbers, spaces and punctuation !?-,." required>
        </div>
    </div>
    ...
    <input type="submit" id="uploadContentButton" value="Upload">
...
<form id="delete-form" hx-post="../includes/deleteContent.php" hx-target="#delete-message" hx-swap="textContent" >
    ...
    <div class="delete-container">
        ...
        <input type="submit" id="deleteContentButton" value="Delete">
    </div>
